...
namespace Licorp_CombineCAD.Services
{
    ...
    public class ExportProfile
    {
        ...
        public string ExportMode { get; set; } = "Individual";
        ...
        public bool CombineAdjacentText { get; set; } = false;
        public bool ConvertRasterToOle { get; set; } = false;
        public bool UpdateScaleLabels { get; set; } = false;
        public bool FlattenZ { get; set; } = false;
        public bool PurgeDrawing { get; set; } = false;
        public bool StripTextFormatting { get; set; } = false;
        public bool AuditDrawing { get; set; } = false;
